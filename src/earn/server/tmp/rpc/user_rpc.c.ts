...
let arr = [[0, _$c("earn/server/tmp/rpc/user.login", new Map<string,string>([["rpc","rpcServer"]]))],[1, _$c("earn/server/tmp/rpc/user.close_connect", new Map<string,string>([["event","net_connect_close"]]))]] as any;
