...
_$define("app/remote/secrets.min", function(require, exports, module) {
    (function (root, factory) {
        ...
        if (typeof define === "function" && define.amd) {
            // AMD. Register as an anonymous secetsMod.
            define([], function () {
                /*eslint-disable no-return-assign */
                return (root.secrets = factory());
                /*eslint-enable no-return-assign */
            });
        } else if (typeof secetsExports === "object") {
            // Node. Does not work with strict CommonJS, but
            // only CommonJS-like environments that support secetsMod.secetsExports,
            // like Node.
            secetsMod.secetsExports = factory(secetsReq("crypto"));
        } else {
        ...
        function getRNG(type) {
            ...
            // It may secetsReq some time and mouse movements to be fully seeded. Uses a modified version
            // of the Fortuna RNG.
