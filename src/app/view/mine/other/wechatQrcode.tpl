...
<div class="new-page" ev-back-click="backPrePage" ev-next-click="shareImg">
    ...
    <div w-class="content">
        ...
        {{: shortMess = [{"zh_Hans":"扫码添加小助手，进"+it.walletName+"官方微信群","zh_Hant":"掃碼添加小助手，進"+it.walletName+"官方微信群","en":""},{"zh_Hans":"扫码关注公众号，随时了解"+it.walletName+"新动态","zh_Hant":"掃碼關注公眾號，隨時了解"+it.walletName+"新動態","en":""}] }}
