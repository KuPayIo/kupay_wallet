<div w-class="base" class="ga-new-page">
    <div w-class="header" title="36px" ev-back-click="doClose">
        <app-components-topBar-topBar>{title:{{it.currencyName}},iconColor:"white",titlePosition:"left",style:"backgroundColor:rgba(68, 140, 255, 1);color:#fff;"}</app-components-topBar-topBar>
    </div>
    <div w-class="body">
        <div w-class="main">
