    ...
    public addNewaddr() {
        ...
        if (this.props.showtype == 1) {
            popNew("app-components-message-messagebox", {
                type: "prompt", title: "添加地址", placeHolder: "标签名"
                , content: "Kye4gFqsnotKvjoVxNy1xoe2CRiC9GdZ8UdtXMcksgUWVFTmam2f"
            }, (r) => {
            ...
            let title = `添加${this.props.coins[this.props.selectnum].name}地址`;
