<div class="new-page" ev-back-click="backPrePage">
    ...
    <div w-class="content">
        <div w-class="inputItem" ev-input-change="oldPswChange">
            <app-components1-input-input>{placeHolder:{{it1.cfgData.itemTitle[0]}} }</app-components1-input-input>
        </div>
        <div style="margin: 0 10px;" ev-psw-change="newPswChange">
            <app-components-password-password>{placeHolder:{{it1.cfgData.itemTitle[1]}} }</app-components-password-password>
        </div>
        <div w-class="inputItem" ev-input-change="rePswChange">
            <app-components1-input-input>{placeHolder:{{it1.cfgData.itemTitle[2]}},clearable:true}</app-components1-input-input>
        </div>
