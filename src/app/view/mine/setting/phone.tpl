<div class="new-page" ev-back-click="backPrePage" ev-next-click="jumpClick">
    ...
    <app-components1-topBar-topBar>{"title":{{topBarTitle}},text:"跳过",textStyle:"margin-right:25px;color:rgba(136,136,136,1);font-size:28px;" }</app-components1-topBar-topBar>
