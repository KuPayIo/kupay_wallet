    ...
    <div w-class="content">
        ...
        <div style="text-align: center;margin-top: 60px;" ev-input-change="codeChange" ev-input-focus="codeFocus">
            ...
            <div w-class="codeBottom" id="codeInput{{ind}}">
                <app-components1-input-input>{index:{{ind}},itype:"number",style:"font-size:64px;color:#368FE5;text-align:center;",input:{{it1.code[ind]}},autofocus:false }</app-components1-input-input>
            </div>
            {{end}}
