    ...
    <div w-class="body">
        ...
        <div w-class="other">
            <div on-tap="uploadAvatar" on-down="onShow">
                ...
                <app-components-basicItem-basicItem>{name:{{itemTitle[6]}},img:true,chooseImage:{{it.chooseImage}},avatarHtml:{{it.avatarHtml}},avatar:{{it.avatar}} }</app-components-basicItem-basicItem>
            </div>
            <div on-tap="changeName" on-down="onShow">
                <app-components-basicItem-basicItem>{name:{{itemTitle[7]}},style:"margin:0;border:none;"}</app-components-basicItem-basicItem>
            </div>
            <div on-tap="changeSex" on-down="onShow">
                <app-components-basicItem-basicItem>{name:{{itemTitle[8]}},describe:{{bindPhone}} }</app-components-basicItem-basicItem>
            </div>
            <div on-tap="changeSignature" on-down="onShow">
                <app-components-basicItem-basicItem>{name:{{itemTitle[9]}},describe:{{bindPhone}} }</app-components-basicItem-basicItem>
            </div>
        </div>
        <div w-class="other">
