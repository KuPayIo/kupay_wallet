<div class="ga-new-page" ev-back-click="backPrePage">
    ...
    <div w-class="ga-content">
        <div w-class="ga-input-father" ev-input-change="inputChange"><app-components-input-input>{itype:"password",placeHolder:"重复新密码",style:{{it1.style}},autofocus:{{true}}}</app-components-input-input></div>
    </div>
