<div class="ga-new-page" ev-back-click="backPrePage">
    ...
    <div w-class="ga-content">
        <div w-class="ga-input-father" ev-input-change="inputChange"><app-components-input-input>{type:"password",placeHolder:"当前密码",style:{{it1.style}}}</app-components-input-input></div>
