<div class="ga-new-page" style="height: 100%;width: 100%;background: #fff;overflow-y: auto;overflow-x: hidden;" ev-btn-tap="doTap">
    ...
    <app-components_level_1-topBar-topBar>{"title":"领红包","background":"orange"}</app-components_level_1-topBar-topBar>
    <div style="margin-top: 200px;"><app-components_level_1-topBar-topBar>{"title":"领红包","centerTitle":true}</app-components_level_1-topBar-topBar></div> 
