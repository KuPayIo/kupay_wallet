...
<div class="new-page" style="background: #F2F2F2;" ev-back-click="backPrePage" ev-next-click="goHistory">
    ...
    <form w-class="content" ev-selectBox-change="changeCoin" id="content">
        ...
        <div style="font-size: 28px;color: #888888;margin: 0 30px;">{{it1.cfgData.changePin[0]}} {{it1.showPin ?
            it1.cfgData.changePin[1] : it1.cfgData.changePin[2]}} {{it1.cfgData.changePin[3]}}
            <span w-class="changeType" on-tap="changePin">{{it1.showPin? it1.cfgData.redEnvType[0] :
                it1.cfgData.redEnvType[1]}}</span>
        </div>
