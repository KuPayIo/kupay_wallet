<div class="new-page" ev-back-click="backPrePage" ev-next-click="goHistory">
    ...
    <div w-class="inputBox" ev-input-change="inputChange">
        ...
        <app-components1-input-input>{placeHolder:{{inputPlaceholder}},style:"border-radius:12px;text-align:center;color:#318DE6;font-size:36px;",input:{{it1.cid}},notUnderLine:true }</app-components1-input-input>
    </div>
