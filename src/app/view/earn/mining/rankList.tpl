<div class="new-page" ev-next-click="goHistory" ev-back-click="backPrePage" ev-refresh-click="refreshPage" style="display: flex;flex-direction: column;">
    <div w-class="title-container">
        <app-components1-topBar-topBar>{"title":{{it1.cfgData.topBarTitle}},"background":"linear-gradient(to right,#25D8A0,#33CACC)",nextImg:"../../res/image/26_white.png",refreshImg:"../../res/image1/refresh_white.png"}</app-components1-topBar-topBar>
        <div w-class="nav">
