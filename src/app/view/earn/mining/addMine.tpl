    ...
    <div style="overflow-y: auto;overflow-x: hidden;height: 100%;">
        <div w-class="content">
            ...
            <div on-tap="show({{ind}})" ev-imgAndBtn-tap="goDetail({{ind}})">
                <app-components-imgAndBtnItem-imgAndBtnItem>{"name":{{val.itemName}},"describe":{{val.itemShort}},"img":{{val.itemImg}},"btnName":"做任务"}</app-components-imgAndBtnItem-imgAndBtnItem>
                {{if val.show}}
