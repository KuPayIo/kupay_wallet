    ...
    <div w-class="body">
        <div w-class="currency-contaier">
            <div w-class="ga-outin-container">
                ...
                <img src="../../res/image/currency/{{it1.outCurrency}}.png" w-class="choose-out-currency" on-tap="outCurrencySelectClick"/>
            ...
            <div w-class="ga-outin-container">
                ...
                <img src="../../res/image/currency/{{it1.inCurrency}}.png" w-class="choose-out-currency" on-tap="inCurrencySelectClick"/>
