<div class="ga-new-page" w-class="ga-new-page">
    ...
    <div w-class="ga-input-father" ev-input-change="redemptionCodeChange">
        <app-components-input-input_simple>{placeHolder:{{it1.placeHolder}},input:{{it1.redemptionCode}},style:"backgroundColor:#F8F8F8;border:1px solid #D6D9DF;borderRadius:6px;padding:0 17px;"}</app-components-input_simple>
    </div>
