<div class="new-page" w-class="new-page">
    ...
    {{for i,v of it1.tabs}} {{let isActive = i===it1.activeNum}}
    <widget w-tag={{v.components}} style="visibility: {{isActive ? 'visible' : 'hidden'}}; z-index:{{isActive ? 0 : -1}};  width:100%;{{isActive ? 'flex:1 0 0;height:100%;overflow: hidden auto;' : 'height: 0;'}}">{isActive:{{isActive}}}</widget>
    {{end}}
</div>