    ...
    <div w-class="body">
        ...
        <div w-class="bottom-box">
            ...
            <div w-class="name-box" ev-input-change="walletNameChange">
                    {{: inputPlace1 = {"zh_Hans":"请输入账号","zh_Hant":"请输入账号","en":""} }}
                <widget w-tag="app-components1-input-input" style="flex: 1;">{input:{{it.walletName}},maxLength:10,placeHolder:{{inputPlace1}}}</widget>
                <img w-class="random" src="../../../res/image/dice.png" on-tap="randomPlayName" id="random" style="display:none;"/>
            </div>
