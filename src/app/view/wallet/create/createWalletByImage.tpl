<div class="new-page" w-class="new-page" ev-back-click="backPrePage">
    ...
    <div w-class="body">
        ...
        {{: tipsCardContent = {"zh_Hans":"照片和照片密码是您找回账号的唯一凭证，一旦丢失，"+it.walletName+"将无法恢复您的账号和资产。照片和照片密码无法修改，请务必牢记并妥善保管。","zh_Hant":"照片和照片密碼是您找回賬號的唯一憑證，一旦丟失，"+it.walletName+"將無法恢復您的賬號和資產。照片和照片密碼無法修改，請務必牢記並妥善保管。","en":""} }}
            ...
            <div w-class="choose-image-container" on-tap="selectImageClick">
                ...
                <div w-class="image-psw-container" on-tap="imagePswClick">
                    ...
                    <div w-class="input-father" ev-input-change="imagePswChange">
                        <app-components-input-suffixInput>{itype:"password",placeHolder:{{inputPlace[0]}},clearable:true,available:{{it.imagePswAvailable}}}</app-components-input-suffixInput>
                    </div>
                    <div w-class="input-father1" ev-input-change="imagePswConfirmChange">
                        <app-components-input-suffixInput>{itype:"password",placeHolder:{{inputPlace[1]}},clearable:true,available:{{it.pswEqualed}}}</app-components-input-suffixInput>
                    </div>
                </div>
                {{end}}
            </div>
