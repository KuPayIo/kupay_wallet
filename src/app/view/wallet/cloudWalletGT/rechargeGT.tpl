        ...
        <div w-class="body">
            ...
            <div w-class="body-top">
                ...
                <div w-class="input-father" ev-input-change="amountChange">
                    ...
                    <app-components1-input-input>{itype:"moneyNum2",maxLength:7,placeHolder:{{inputPlace}},input:{{it.total}},style:"padding:0;background:transparent;"}</app-components1-input-input>
                </div>
            </div>
