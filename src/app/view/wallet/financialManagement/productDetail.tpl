...
<div>
    ...
    <div w-class="top-head">
        ...
        <div w-class="row3"><div w-class="progress"></div></div>
        <div w-class="row4"><div w-class="sold">已售&nbsp;75%</div></div>
    </div>
    <div w-class="bottom-box">
        ...
        <div ev-btn-tap="purchaseClicked" w-class="btn"><app-components-btn-btn>{"name":"购买","types":"big","color":"blue"}</app-components-btn-btn></div>
    </div>
</div>
</div>