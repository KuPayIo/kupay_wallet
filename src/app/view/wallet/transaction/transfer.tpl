            ...
            <div>
                <div w-class="item">
                    ...
                    <div w-class="input-father" ev-input-change="amountChange">
                        <app-components-input-input>{itype:"number",placeHolder:"输入金额",style:"padding:0;"}</app-components-input-input>
                ...
                <div w-class="item">
                    ...
                    <div w-class="input-father1" ev-input-change="toAddrChange">
                        <app-components-input-input>{placeHolder:"填入地址",style:"padding:0;",input:{{it1.toAddr}}}</app-components-input-input>
                    </div>
                </div>
                <div w-class="item">
