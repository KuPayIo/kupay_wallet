            ...
            <div>
                <div w-class="item">
                    ...
                    <div w-class="input-father" ev-input-change="amountChange">
                        <app-components-input-input>{itype:"number",placeHolder:{{it1.cfgData.inputPlace[0]}},style:"padding:0;font-size:36px;",input:{{it1.amount}},disabled:{{it1.inputDisabled}}}</app-components-input-input>
