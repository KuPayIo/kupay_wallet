<div class="new-page" w-class="new-page" >
    ...
    <div w-class="record-list" >
        ...
        <app-components-fourParaImgItem-fourParaImgItem>{"name":{{behavior}},"data":{{v.amountShow}},"time":{{v.timeShow}},img:{{'../../res/image/' + v.iconShow}},describe:{{v.statusShow ? v.statusShow:""}} }</app-components-fourParaImgItem-fourParaImgItem>
        </div>
        {{end}}
    </div>
    </div>  
