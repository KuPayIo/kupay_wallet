<div class="new-page" w-class="new-page">
    ...
    <div w-class="record-list">
        ...
        <app-components-fourParaImgItem-fourParaImgItem>{"name":{{v.behavior}},"data":{{v.amountShow}},"time":{{v.timeShow}},img:{{v.iconShow}},describe:{{v.statusShow}}}</app-components-fourParaImgItem-fourParaImgItem>
        </div>
        {{end}}
    </div>
    </div>  
