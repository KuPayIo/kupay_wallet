    ...
    <div w-class="body">
        ...
        <div w-class="body-top">
            ...
            <div w-class="other-input" ev-input-change="inputChange">
                ...
                <app-components-input-input>{itype:"integer",maxLength:5,placeHolder:{{inputPlace}},input:{{it.inputValue}},style:"color:#318DE6;background:transparent;"}</app-components-input-input>
            </div>
        </div>
