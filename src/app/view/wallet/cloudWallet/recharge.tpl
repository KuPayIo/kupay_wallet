        ...
        <div w-class="main">
            <div w-class="item1">
                ...
                <div w-class="input-father" ev-input-change="amountChange">
                    <app-components1-input-input>{itype:"number",placeHolder:{{it1.cfgData.inputPlace}},style:"padding:0;",input:{{it1.amount}},disabled:{{it1.inputDisabled}}}</app-components1-input-input>
                </div>
            </div>
            <div w-class="item1">
