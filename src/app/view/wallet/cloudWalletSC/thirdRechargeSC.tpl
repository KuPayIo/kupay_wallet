<div class="new-page" w-class="new-page" ev-back-click="backPrePage">
        ...
        <div w-class="body">
            ...
            <div w-class="body-top">
                <div w-class="box1">
                    <div w-class="order-item"><widget w-tag="pi-ui-lang">{"zh_Hans":"订单号","zh_Hant":"訂單號","en":""}</widget><span>FX52366512666</span></div>
                ...
                <div w-class="box2">
                    <div w-class="order-item"><widget w-tag="pi-ui-lang">{"zh_Hans":"收款方","zh_Hant":"收款方","en":""}</widget><span>FX52366512666</span></div>
                    <div w-class="order-item"><widget w-tag="pi-ui-lang">{"zh_Hans":"收款价格","zh_Hant":"收款價格","en":""}</widget><span>FX52366512666</span></div>
                    <div w-class="order-item" style="color:rgba(245,162,100,1);"><widget w-tag="pi-ui-lang">{"zh_Hans":"还需支付","zh_Hant":"還需支付","en":""}</widget><span>FX52366512666</span></div>
                </div>
            </div>
            {{% 选择支付方式}}
