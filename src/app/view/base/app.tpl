...
<div w-class="ga-bottom-tab-bar-container" >
    ...
    <div w-class="ga-tab-bar-item {{it1.isActive == index ? 'ga-tab-bar-item-active' : ''}}" on-down="tabBarChangeListener(e,{{index}})">
        <img src="../../res/image1/{{item.iconActive}}" w-class="ga-tab-bar-icon {{it1.isActive == index ? '' : 'ga-tab-bar-icon-none'}}" />
        <img src="../../res/image1/{{item.icon}}" w-class="ga-tab-bar-icon {{it1.isActive == index ? 'ga-tab-bar-icon-none' : ''}}" />
