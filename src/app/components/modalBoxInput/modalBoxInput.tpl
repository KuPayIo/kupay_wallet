<div w-class="modal-mask" class="new-page">
    <div w-class="body">
        ...
        <div style="height: 90px;" ev-input-change="change">
            <app-components-input-input>{placeHolder: {{it.placeholder?it.placeholder:""}},itype:{{it.itype?it.itype:"text"}},style:"padding:0;font-size:28px;",underLine:true,autofocus:true }</app-components-input-input>
        </div>
        <div w-class="btns">
            {{if it.cancelText}}
