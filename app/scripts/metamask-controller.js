...
const EthQuery = require('eth-query')//like web3 but for minimalists web3的精简版 candybox
const RpcEngine = require('json-rpc-engine')//进行json rpc调用的json-rpc-engine candybox
...
const NetworkController = require('./controllers/network')//网络连接 candybox
...
const InfuraController = require('./controllers/infura')//提供以太坊的网关服务 candybox
...
module.exports = class MetamaskController extends EventEmitter {
  ...
  constructor (opts) {
    ...
    // rpc provider
    this.provider = this.initializeProvider()//设置了provider的地址
